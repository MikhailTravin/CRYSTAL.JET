(() => {
    ...
    da.init();
    function indents() {
        let pagination = document.querySelector(".main-home__pagination");
        let mainHomeBody = document.querySelector(".main-home__container");
        ...
        if (document.documentElement.clientWidth > 767.98) pagination.style.right = sumMainHome + "px"; else pagination.style.right = "auto";
    }
    ...
    if (servicesItems) servicesItems.forEach((item => {
        const id = item.dataset.id;
        const contentSelector = `div[data-id='${id}'].popup`;
